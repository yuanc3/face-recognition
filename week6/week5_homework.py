...
train_dataloader = torch.utils.data.DataLoader(
    dataset=TrainDataset(
        face_dir="../week5/Datasets/vggface2_train_face",
        csv_name='../week5/Datasets/vggface2_train_face.csv',
        num_triplets=1000,
        training_triplets_path='../week5/Datasets/training_triplets_1000_20201101.npy',
...
for epoch in range(start_epoch, end_epoch):
    ...
    state = {
            ...
            'model_architecture': 'resnet18Triplet',
            'optimizer_model_state_dict': optimizer_model.state_dict()
    }
    if min_loss>avg_triplet_loss:
        min_loss=avg_triplet_loss
        print("avg_triplet_loss: ", avg_triplet_loss)
        torch.save(state, 'Model_training_checkpoints/model_{}_triplet.pt'.format('resnet18'))
