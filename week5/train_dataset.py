...
class TrainDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        #neg_img = self.preprocess(neg_img, self.detector, self.predictor, self.img_size)
        ...
        #pos_class = torch.from_numpy(np.array([pos_class]))
        #neg_class = torch.from_numpy(np.array([neg_class]))
